...
const Statique = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <IconWrapper>
          <FontAwesomeIcon icon={faChalkboardTeacher} style={{ color: 'blue' }} className="fa-3x mb-4" /> {/* Utilisation de l'icône des instructeurs */}
        </IconWrapper>
        <Title className="text-blue fw-bold mb-3">+ {instructeurCount}</Title> {/* Affichage du nombre d'instructeurs */}
